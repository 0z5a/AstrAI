...
class TestQuantGemm:
    ...
    def test_w8a8(self, m, n, k):
        ...
        out = mm_w8a8(x8.reshape(m, k), w8, xs, ws)
    ...
    def test_bias_fusion(self, m, n, k):
        ...
        fused = mm_w8a16(x, w8, ws, bias=bias)
...
class TestQuantGemmValidation:
    ...
    def test_scale_extent_rejected(self):
        ...
        with pytest.raises(RuntimeError, match="w_scale"):
            mm_w8a16(x, w8, bad)
